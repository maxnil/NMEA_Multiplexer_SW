/*
 * NMEA_Multiplexer_v3AboutBox.java
 */
...
public class aboutBox extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(nmea_multiplexer_v3.NMEA_Multiplexer_v3App.class).getContext().getResourceMap(aboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(nmea_multiplexer_v3.NMEA_Multiplexer_v3App.class).getContext().getActionMap(aboutBox.class, this);
